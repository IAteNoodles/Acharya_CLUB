...
export function EventDetailPage() {
  ...
  if (error || !event) {
    return (
      <EmptyState
        ...
        action={
          <Link to="/teacher/events" className="text-sm font-medium underline underline-offset-4">
            Back to events
          </Link>
        }
      />
  ...
  return <ManageEventDetail event={event} role="teacher" backHref="/teacher/events" />;
}
